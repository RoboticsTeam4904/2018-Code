...
import org.usfirst.frc4904.autonly.farsidescalestrategies.FarLeftScaleRightDistance;
...
import org.usfirst.frc4904.autonly.farsideswitchstrategies.FarLeftSwitchRightDistance;
...
public class Robot extends CommandRobotBase {
	...
	public void initialize() {
		...
		autoChooser.addObject(new FarLeftSwitchLeftDistance());
		autoChooser.addObject(new FarLeftSwitchRightDistance());
		autoChooser.addObject(new FarRightSwitchLeftDistance());
		autoChooser.addObject(new FarRightSwitchRightDistance());
		autoChooser.addObject(new FarLeftScaleLeftDistance());
		autoChooser.addObject(new FarLeftScaleRightDistance());
		autoChooser.addObject(new FarRightScaleLeftDistance());
