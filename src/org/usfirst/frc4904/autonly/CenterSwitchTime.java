...
public class CenterSwitchTime extends Strategy {
	...
	public CenterSwitchTime() {
		addSequential(
			new ChassisConstant(RobotMap.Component.chassis, 0.0, 0.0, 0.0, TIME_APPROACH_MID));
		...
		addSequential(
			new ChassisConstant(RobotMap.Component.chassis, 0.0, 0.0, 0.0, TIME_MID_SWITCH));
		addSequential(new RunIfElse(
			new ChassisTurn(RobotMap.Component.chassis, DEGREES_TURN_RIGHT, RobotMap.Component.navx,
				RobotMap.Component.chassisTurnMC),
			new ChassisTurn(RobotMap.Component.chassis, DEGREES_TURN_LEFT, RobotMap.Component.navx,
		...
		addSequential(
			new ChassisConstant(RobotMap.Component.chassis, 0.0, 0.0, 0.0, TIME_MID_SCALE));
	}
